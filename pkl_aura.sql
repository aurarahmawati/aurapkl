...
INSERT INTO `jadwal` (`id`, `tgl_kegiatan`, `waktu_mulai`, `waktu_selesai`, `keterangan`, `lokasi`, `status`, `latitude`, `longitude`, `created_at`, `updated_at`) VALUES
	(11, '2025-06-10', '15:11:00', '12:16:00', 'pendataan', 'Jalan Pangeran Hidayatullah, Pengambangan, East Banjarmasin, Banjarmasin, South Kalimantan, Kalimantan, 70237, Indonesia', 'Selesai', -3.316333, 114.617956, '2025-06-09 20:12:47', '2025-06-09 20:12:47');
...
INSERT INTO `user` (`id`, `username`, `password`, `remember_token`, `roles`, `created_at`, `updated_at`, `name`, `pegawai_id`) VALUES
	(1, 'admin', '$2y$10$.p61gnLkCqOnZxeLq9yTzuwUmuUiFOjXjM3FPmmZYrKuwXg09TReG', 'e5tRizEjlfaWwvGnVw19FdOeITL7XKM4Nwa8zLbMLLouR72twdILiIMq8aFT', 'admin', '2024-12-25 01:04:14', '2025-01-24 00:11:16', 'admin', NULL),
	(8, 'Hermansyah', '$2y$10$z/u6YGB2.Tox8ecAFbHDLuDMnzKnajIaVENu6kK8uYgmQ5jCRtwLO', 'xeeh9qSqWn9ZjH8gDqr7gD8YsOMdqzjcUSoTEkNXbZDhELbwxjz6uLCbFksa', 'pegawai', '2025-01-10 21:02:59', '2025-01-10 21:03:13', 'Hermansyah', 7),
